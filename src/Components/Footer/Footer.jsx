...
const Footer = () => {
    return (
        <footer className="footer items-center p-4 mt-[500px] lg:mt-10 bg-neutral text-neutral-content">
  ...
  <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
    <div className="flex gap-4">
        <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
            <img src="https://www.instagram.com/_._nahidaaa/" alt="Instagram" className="w-8 h-8" />
        </a>
        <a href="https://github.com/nahida30" target="_blank" rel="noopener noreferrer">
            <img src="/public/images/github.png" alt="GitHub" className="w-8 h-8" />
        </a>
        <a href="www.linkedin.com/in/nahida-zaman-bina-b1549623a" target="_blank" rel="noopener noreferrer">
